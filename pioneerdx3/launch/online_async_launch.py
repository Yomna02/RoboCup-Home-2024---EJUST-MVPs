...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory("pioneerdx3"),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        description='/opt/ros/foxy/share/slam_toolbox/config/mapper_params_online_async.yaml')
